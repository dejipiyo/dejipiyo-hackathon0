...
export type SearchPikachuQueryVariables = Exact<{ [key: string]: never; }>;


export type SearchPikachuQuery = { __typename?: 'Query', pokemon?: { __typename?: 'Pokemon', number?: string | undefined, name?: string | undefined, image?: string | undefined } | undefined };
 ...
 * @example
 * mockSearchPikachuQuery((req, res, ctx) => {
 *   return res(
 *     ctx.data({ pokemon })
 *   )
 * })
 */
export const mockSearchPikachuQuery = (resolver: ResponseResolver<GraphQLRequest<SearchPikachuQueryVariables>, GraphQLContext<SearchPikachuQuery>, any>) =>
  graphql.query<SearchPikachuQuery, SearchPikachuQueryVariables>(
    'searchPikachu',
    resolver
  )
